...
class RankLSTM:
    ...
    def get_batch(self, offset=None):
        ...
        return self.eod_data[:, offset:offset + seq_len, :], np.expand_dims(mask_batch, axis=1),np.expand_dims(
...
if __name__ == '__main__':
    ...
    rank_LSTM = RankLSTM(data_path=args.p, market_name=args.m, tickers_fname=args.t, parameters=parameters,
                         gpu=args.gpu)
