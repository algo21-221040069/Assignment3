...
if __name__ == '__main__':
    ...
    RR_LSTM = ReRaLSTM(data_path=args.p, market_name=args.m, tickers_fname=args.t, relation_name=args.rel_name,
                       emb_fname=args.emb_file, parameters=parameters, gpu=args.gpu, in_pro=args.inner_prod)
